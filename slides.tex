...
\setbeamertemplate{background}{
\tikz[overlay,remember picture] \node[opacity=0.1, at=(current page.center), align=center] {\\[10pt]
{\transparent{0.1}\includegraphics[width=\paperwidth]{images/hqs_jets_trajectories.png}}};
}
\setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{normal}\blacktriangleright}$}}} 
\begin{frame}[plain,noframenumbering]{}
    \begin{center}
...
\begin{frame}[plain, noframenumbering]
    ...
    \blfootnote{\scriptsize DA, Băran, Greco, Ipp, Müller, Ruggieri  \href{https://arxiv.org/abs/2303.05599}{{\color{palgold}\texttt{[2303.05599]}$^\text{\tiny\faExternalLink}$}}}
\end{frame}
\setbeamertemplate{background}{}
...
%     \end{center}
%     \vspace{-20pt}
%     \blfootnote{\scriptsize DA, Băran, Greco, Ipp, Müller, Ruggieri  \href{https://arxiv.org/abs/2307.07999}{{\color{palgold}\texttt{[2307.07999]}$^\text{\tiny\faExternalLink}$}}}
% \end{frame}
...
%                     \item \large {\color{Maroon}Rapid increase in $\langle \delta p^2\rangle$ at early $\delta\tau$}\\[10pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
...
%                 \begin{itemize}\itemsep0em 
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{Maroon}\blacktriangleright}$}}} 
%                     \item \large {\color{Maroon} Large $\hat{q}$ peak at early $\delta\tau$}\\[10pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
...
%                 \begin{itemize}\itemsep0em 
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{Maroon}\blacktriangleright}$}}} 
%                     \item \large {\color{Maroon} Large $\kappa$ peak at early $\delta\tau$}\\[10pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
...
%         {\large\textit{Candidates: $R_{AA}$, $v_2$, angular correlations...}}
%     \end{center}
% \end{frame}
% \setbeamertemplate{background}{}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Ruggieri, Das \href{https://arxiv.org/abs/1805.09617}{\color{palgold}\texttt{[1805.09617]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Sun, Coci, Das, Plumari, Ruggieri, Greco \href{https://arxiv.org/abs/1902.06254}{\color{palgold}\texttt{[1902.06254]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%             \footnotesize
%                 \begin{itemize}
%                     \item {\color{lightgray}{\bfseries EKRT} initial condition}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Andres, Armesto, Niemi, Paatelainen, Salgado \href{https://arxiv.org/abs/1902.03231}{\color{palgold}\texttt{[1902.03231]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%                     \item {\color{lightgray}Different {\bfseries initial $\boldsymbol{T}$ profiles}}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Zigic, Ilic, Djordjevic, Djordjevic \href{https://arxiv.org/abs/1908.11866}{\color{palgold}\texttt{[1908.11866]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Andres, Apolinário, Dominguez, Gonzalez Martinez, Salgado \href{https://arxiv.org/abs/2211.10161}{\color{palgold}\texttt{[2211.10161]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize DA, Greco, Lappi, Mäntysaari, M\"{u}ller \href{https://arxiv.org/abs/2409.10564}{\color{palgold}\texttt{[2409.10564]}$^\text{\tiny\faExternalLink}$}, \href{https://arxiv.org/abs/2409.10565}{\color{palgold}\texttt{[2409.10565]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
%     \vspace{-20pt}
%     \blfootnote{\scriptsize Cacciari, Greco, Nason \href{https://arxiv.org/abs/hep-ph/9803400}{{\color{raablue}\texttt{[hep-ph/9803400]$^\text{\tiny\faExternalLink}$}}}}
% \end{frame}
...
\begin{frame}[plain,noframenumbering]{}
    \begin{center}
        \vspace{1cm}
        {\huge\color{red}\bfseries Open questions}\\[0.4cm]
...
%     \begin{center}
%         \vspace{1cm}
%         {\Large\color{normal}\color{red}\bfseries Question 1:}\\[0.3cm]
...
% \begin{frame}[noframenumbering]
%     \frametitle{Going from classical broadening...}
%     \vspace{10pt}
%     \begin{center}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Option 1: }Classical radiation in glasma}
%     % \framesubtitle{}
%     \vspace{-15pt}
%     \begin{center}
%         \begin{columns}[onlytextwidth,t]
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Gelfand, Ipp, Müller \href{https://arxiv.org/abs/1605.07184}{{\color{raablue}\texttt{[1605.07184]$^\text{\tiny\faExternalLink}$}}} Ipp, Müller \href{https://arxiv.org/abs/1605.07184}{{\color{palviolet}\texttt{[1605.07184]$^\text{\tiny\faExternalLink}$}}}\\
%     \hspace{16pt}$^{\color{raapink}\boldsymbol{\star}}$Liu, Das, Greco, Ruggieri \href{https://arxiv.org/abs/2011.05818}{\color{raapink}\texttt{[2011.05818]}$^\text{\tiny\faExternalLink}$} no Cherenkkov instability for slow heavy quarks 
%     }
% \end{frame}
...
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Gelfand, Ipp, Müller \href{https://arxiv.org/abs/1605.07184}{{\color{raablue}\texttt{[1605.07184]$^\text{\tiny\faExternalLink}$}}} Ipp, Müller \href{https://arxiv.org/abs/1605.07184}{{\color{palviolet}\texttt{[1605.07184]$^\text{\tiny\faExternalLink}$}}}\\
%     \hspace{16pt}$^{\color{ForestGreen}\boldsymbol{\star}}$Vranic, Martins, Fonseca, Silva \href{https://arxiv.org/abs/1502.02432}{\color{ForestGreen}\texttt{[1502.02432]}$^\text{\tiny\faExternalLink}$} RR force in PIC simulations 
%     }
% \end{frame}
...
% \begin{frame}[noframenumbering]
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Option 2: }Embed standard calculations...}
%     % \vspace{10pt}
%     \hspace{20pt}
%     % \begin{center}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Development: }Jet quenching in glasma}
...
%                         \item Fields constant in {\bfseries\color{red}color domains $\boldsymbol{l\sim 1/Q_s}$}
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Barata, Hauksson, López, Sadofyev \href{https://arxiv.org/abs/2406.07615}{{\color{raablue}\texttt{[2406.07615]$^\text{\tiny\faExternalLink}$}}} Aurenche, Zakharov \href{https://arxiv.org/abs/1205.6462}{{\color{raablue}\texttt{[1205.6462]$^\text{\tiny\faExternalLink}$}}}\\
%     \hspace{16.5pt}\textit{Correlation domains from Agostini, Altinoluk, Armesto \href{https://arxiv.org/abs/2103.08485}{{\color{raapink}\texttt{[2103.08485]$^\text{\tiny\faExternalLink}$}}}}}
% \end{frame}
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Barata, Hauksson, López, Sadofyev \href{https://arxiv.org/abs/2406.07615}{{\color{raablue}\texttt{[2406.07615]$^\text{\tiny\faExternalLink}$}}}}
% \end{frame}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Development: }Quantum jets in glasma}
...
%                         \item Interaction term with gluon field $\color{red}\boldsymbol{\mathcal{A}}$ $\rightarrow$ {\bfseries\color{red} glasma}
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
%             \end{center}
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Li, Zhao, Maris, Chen, Li, Tuchin, Vary \href{https://arxiv.org/abs/2002.09757}{{\color{raablue}\texttt{[2002.09757]$^\text{\tiny\faExternalLink}$}}} Li, Lappi, Zhao \href{https://arxiv.org/abs/2107.02225}{{\color{raablue}\texttt{[2107.02225]$^\text{\tiny\faExternalLink}$}}}\\
%      \hspace{16pt}Li, Lappi, Zhao, Salgado \href{https://arxiv.org/abs/2305.12490}{{\color{raablue}\texttt{[2305.12490]$^\text{\tiny\faExternalLink}$}}} Lamas, Lappi, Li, Salgado, DA \texttt{[in preparation]}}
% \end{frame}
...
%     \begin{center}
%         \vspace{1cm}
%         {\Large\color{normal}\color{red}\bfseries Question 2:}\\[0.3cm]
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Option 1: }Couple heavy quark transport}
%     \vspace{-10pt}
%     \begin{center}
...
%    \end{center} 
%     \blfootnote{\scriptsize Greco \href{https://indico.ectstar.eu/event/40/contributions/1055/attachments/745/968/Greco-transport-ECT.pdf}{{\color{customblue}\texttt{[ECT$^\star$ 20]}$^\text{\tiny\faExternalLink}$}} Sun, Coci, Das, Plumari, Ruggieri, Greco \href{https://arxiv.org/abs/1902.06254}{{\color{customblue}\texttt{[1902.06254]$^\text{\tiny\faExternalLink}$}}}}
% \end{frame}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily Option 2: }Couple glasma to EKT}
%     \vspace{-15pt}
%     \begin{center}
%         \begin{columns}
%             \column{.03\textwidth}
%             \column{.45\textwidth}
%             \begin{center}\includegraphics[width=0.75\columnwidth]{images/qhat_glasma_ekt.png}\end{center}
%             \column{.03\textwidth}
%             \column{.45\textwidth}
%                 \\[10pt]
%                 \begin{center}\includegraphics[width=0.9\columnwidth]{images/kappa_glasma_ekt.png}\end{center}
%             \column{.03\textwidth}
%         \end{columns}
%     \end{center}

%    \begin{center}
%     \begin{custombox2}{Couple glasma + EKT}{lightgray}
%         \small
%         \begin{varwidth}{0.84\textwidth}
%         \begin{itemize}\itemsep0em 
%             \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
%             \item Current coupling: $\varepsilon_\mathrm{glasma}$ at $Q_s=2\,\mathrm{GeV}$ matched to $\varepsilon_\mathrm{EKT}$ $\Rightarrow$ $Q_s=1.4\,\mathrm{GeV}$
%             \item Extract {\bfseries\color{palgold} gluon distribution function} $f_{\mathrm{glasma}}$ $\xrightarrow{\text{input}}$ EKT $\Rightarrow$ $\hat{q}$, $\kappa$
%         \end{itemize}
%         \end{varwidth}
%     \end{custombox2}
%    \end{center} 
%     \blfootnote{\scriptsize Boguslavski, Kurkela, Lappi, Lindenbauer, Peuron \href{https://arxiv.org/abs/2303.12595}{{\color{palgold}\texttt{[2303.12595]}$^\text{\tiny\faExternalLink}$}}, \href{https://arxiv.org/abs/2303.12520}{{\color{palgold}\texttt{[2303.12520]}$^\text{\tiny\faExternalLink}$}}\\
%     \hspace{16.5pt}Greif, Greiner, Schenke, Schlichting, Xu \href{https://arxiv.org/abs/1903.00314}{{\color{palviolet}\texttt{[1903.00314]}$^\text{\tiny\faExternalLink}$}} IP-Glasma + KT}
% \end{frame}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{red}\bfseries\sffamily The dream: }Boltzmann-Vlasov in glasma}
...
%                     \footnotesize
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
%                     \item Coupled Wong-Yang-Mills, {\bfseries\color{red}missing $\boldsymbol{j^\mu}$}
%                 \end{itemize}
%                 \end{varwidth}
%             \end{custombox2}
...
%                         \footnotesize
%                         \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{lightgray}\blacktriangleright}$}}} 
%                         \item Separate {\bfseries\color{palteal} soft (background)} particles \\ from {\bfseries\color{red}hard (test)} particles at $k^*$
%                         \item {\bfseries\color{red}Hard} particles $\rightarrow$ collision term $\mathcal{C}$
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Dumitru, Nara \href{https://arxiv.org/abs/hep-ph/0503121}{{\color{palteal}\texttt{[hep-ph/0503121]$^\text{\tiny\faExternalLink}$}}} Dumitru, Nara, Strickland \href{https://arxiv.org/abs/hep-ph/0604149}{{\color{palteal}\texttt{[hep-ph/0604149]$^\text{\tiny\faExternalLink}$}} \color{normal}plasma instabilities}\\
%      \hspace{16.5pt}Dumitru, Nara, Schenke, Strickland \href{https://arxiv.org/abs/0710.1223}{{\color{palteal}\texttt{[0710.1223]$^\text{\tiny\faExternalLink}$}}} Schenke \href{https://arxiv.org/abs/0810.4306}{{\color{palteal}\texttt{[0810.4306]$^\text{\tiny\faExternalLink}$}}} figure with particles}
% \end{frame}
...
%     \begin{center}
%         \vspace{1cm}
%         {\Large\color{normal}\color{red}\bfseries Question 3:}\\[0.3cm]
...
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{red}\blacktriangleright}$}}} \item {\bfseries\color{red} Other observables? Jets?}
%                 \end{itemize}
%                 \end{varwidth}
%             \end{custombox2}
...
%                         \item Couple glasma to next stages and perform \\ {\bfseries\color{bayesian}bayesian analysis} $\Rightarrow$ {\bfseries\color{red}sensitivity to glasma}
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
...
%     \end{center}
%     \vspace{-10pt}
%     \blfootnote{\scriptsize Ruggieri, Das \href{https://arxiv.org/abs/1805.09617}{\color{starrysecond}\texttt{[1805.09617]}$^\text{\tiny\faExternalLink}$} Liu, Das, Greco, Ruggieri \href{https://arxiv.org/abs/2011.05818}{\color{starrysecond}\texttt{[2011.05818]}$^\text{\tiny\faExternalLink}$} Sun, Coci, Das, Plumari, Ruggieri, Greco \\
%      \hspace{16pt}\href{https://arxiv.org/abs/1902.06254}{{\color{starrysecond}\texttt{[1902.06254]$^\text{\tiny\faExternalLink}$}}} DA, Greco, Lappi, Mäntysaari, M\"{u}ller \href{https://arxiv.org/abs/2409.10564}{\color{starrysecond}\texttt{[2409.10564]}$^\text{\tiny\faExternalLink}$}, \href{https://arxiv.org/abs/2409.10565}{\color{starrysecond}\texttt{[2409.10565]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
\begin{frame}[plain,noframenumbering]{}
    \begin{center}
        \vspace{1cm}
        {\Large\color{normal}\color{red}\bfseries Question 4:}\\[0.3cm]
...
\begin{frame}
    ...
    % \begin{center}
        \begin{columns}[onlytextwidth,c]
            \column{.01\textwidth}
            \column{.02\textwidth}
                \rotatebox{90}{\large\bfseries\color{Mahogany} 3+1D glasma}
            \column{.02\textwidth}
            \column{.31\textwidth}
                \begin{center}
                    ...
                    \\[-4pt]
                    {\tiny Ipp, Leuthner, Müller, Schlichting, Schmidt, Singh} \\ \tiny \href{https://arxiv.org/abs/2401.10320}{\color{Mahogany}\texttt{[2401.10320]}\scalebox{.6}{$^\text{\tiny\faExternalLink}$}}
                \end{center}
            \column{.01\textwidth}
            \column{.3\textwidth}
                \begin{center}
                    ...
                    \\[-4pt]
                    {\tiny Schlichting, Singh} \\ \tiny \href{https://arxiv.org/abs/2010.11172}{\color{Mahogany}\texttt{[2010.11172]}\scalebox{.6}{$^\text{\tiny\faExternalLink}$}}
                \end{center}
            \column{.01\textwidth}
            \column{.3\textwidth}
                % \vspace{-20pt}
                \begin{center}
                    ...
                    \\[-4pt]
                    {\tiny Garcia-Montero, Elfner, Schlichting} \\ \tiny \href{https://arxiv.org/abs/2308.11713}{\color{Mahogany}\texttt{[2308.11713]}\scalebox{.6}{$^\text{\tiny\faExternalLink}$}}
                \end{center}
            \column{.02\textwidth}
        \end{columns}    
        \vspace{-10pt} 
        \begin{columns}[onlytextwidth,c]
            \column{.01\textwidth}
            \column{.02\textwidth}
                \rotatebox{90}{\large\bfseries\color{blue} proton structure}
            \column{.02\textwidth}
            \column{.3\textwidth}
                \begin{center}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \node[align=center] at (0,4) {
                ...
                \Large from $\color{red}\boldsymbol{pp}$, $\color{red}\boldsymbol{pA}$ to $AA$ collisions \\[20pt]
                \Large Effect of glasma transport\\ \Large in {\bfseries\color{red}small systems}
            };
        \end{tikzpicture} 
    \end{center}
\end{frame}
