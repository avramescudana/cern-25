...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Avramescu, Greco, Lappi, Mäntysaari, M\"{u}ller \href{https://arxiv.org/abs/2409.10564}{\color{palgold}\texttt{[2409.10564]}$^\text{\tiny\faExternalLink}$}, \href{https://arxiv.org/abs/2409.10565}{\color{palgold}\texttt{[2409.10565]}$^\text{\tiny\faExternalLink}$}}
% \end{frame}
...
\begin{frame}[plain,noframenumbering]{}
    \begin{center}
        ...
        % {\large\textit{Ongoing works, new perspectives}}
    \end{center}
\end{frame}
\setbeamertemplate{background}{}
...
\begin{frame}
    \frametitle{Classical radiation in glasma}
    % \framesubtitle{}
    \vspace{10pt}
    \begin{center}
        \includegraphics[height=0.7\paperheight]{images/momentum_broadening_flipped_jetquenched.png}
...
\begin{frame}[noframenumbering]
    \frametitle{Embed standard calculations...}
    % \vspace{10pt}
    \hspace{20pt}
    % \begin{center}
...
\begin{frame}
    \frametitle{Quantum jet evolution}
           ...
           \begin{center}
            ...
            \begin{center}
                \begin{custombox2}{\normalsize tBLFQ}{raablue}
                    ...
                    \end{varwidth}
                \end{custombox2}
                \begin{custombox2}{\normalsize Quantum jet in glasma}{raapink}
                    \small
                    \begin{varwidth}{0.95\textwidth}
                    \begin{itemize}\itemsep0em 
                        \itemsep0em
                        ...
                        \item Schroedinger equation for jet evolution from light-cone quantized QCD
                        \item Interaction part with numerical glasma field $\mathcal{A}$
                    \end{itemize}
                    \end{varwidth}
                \end{custombox2}
            \end{center}
    ...
    \end{center}
    \vspace{-10pt}
    \blfootnote{\scriptsize Li, Lappi, Zhao \href{https://arxiv.org/abs/2107.02225}{{\color{raablue}\texttt{[2107.02225]$^\text{\tiny\faExternalLink}$}}}}
\end{frame}
