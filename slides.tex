...
%     \blfootnote{\scriptsize Apolinario - \textit{Jetography via the Quark-Gluon Plasma} \href{https://indico.cern.ch/event/1385550/}{{\color{jyured}\texttt{[CERN 24]$^\text{\tiny\faExternalLink}$}}}}
% \end{frame}
% \setbeamertemplate{background}{}
...
% }
% \begin{frame}
%     \frametitle{Jets as probes of the {\color{jyured}early stage}}
%     % \framesubtitle{Stages and scales of interest}
%     \blfootnote{\scriptsize Apolinario - \textit{Monte Carlo modeling of jets} \href{https://indico.uni-muenster.de/event/1409/contributions/2412/}{{\color{jyured}\texttt{[Plenary Hard Probes 23]$^\text{\tiny\faExternalLink}$}}}, adapted}
% \end{frame}
% \setbeamertemplate{background}{}
...
%     \vspace{-5pt}    
%     \blfootnote{\scriptsize Ke - \textit{Open Heavy Flavor: Theory} \href{https://indico.cern.ch/event/1339555/contributions/6038190/}{{\color{jyured}\texttt{[Plenary Hard Probes 24]$^\text{\tiny\faExternalLink}$}}}}
% \end{frame}
...
% \begin{frame}[noframenumbering]
%     \frametitle{Heavy quarks as probes of the {\color{jyured}early stage}}
...
%     \end{center}
%     \vspace{-10pt}    
%     \blfootnote{\scriptsize Ke - \textit{Open Heavy Flavor: Theory} \href{https://indico.cern.ch/event/1339555/contributions/6038190/}{{\color{jyured}\texttt{[Plenary Hard Probes 24]$^\text{\tiny\faExternalLink}$}}}, adapted}
% \end{frame}
...
%                 \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{palviolet}\blacktriangleright}$}}} 
%                 \footnotesize
%                 \item Analytical {\color{jyured}pure gauge} fields before collision
...
%     \begin{itemize}\itemsep0em 
%         \setbeamertemplate{itemize item}{\raisebox{0.1em}{\scalebox{0.7}{${\color{starrysecond}\blacktriangleright}$}}} 
%         \item \begin{center} Boltzmann-Vlasov equation for {\color{jyured}collisionless} non-Abelian plasma\\[10pt]
%             ${\color{customred}p^\mu}[\partial_\mu+g {\color{customyellow}Q^a} {\color{starrysecond}F^{\mu\nu}}({\color{customblue}x^\mu})\partial^\nu_{{\color{customred}p^\mu}}+gf^{abc}{\color{starrysecond}A^b_\mu}({\color{customblue}x^\mu}){\color{customyellow}Q^c}\partial_{{\color{customyellow}Q^a}}]\boldsymbol{f}({\color{customblue}x^\mu}, {\color{customred}p^\mu}, {\color{customyellow}Q^a})={\color{jyured}0}$\\[10pt]\end{center}
...
% \begin{frame}
%     \frametitle{{\normalsize\color{jyured}\bfseries\sffamily Option 2: }Couple glasma to EKT}
%     \vspace{-15pt}
%     \begin{center}
%         \begin{columns}
%             \column{.03\textwidth}
